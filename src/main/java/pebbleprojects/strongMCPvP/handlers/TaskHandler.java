...
public final class TaskHandler {
    ...
    public BukkitTask runTaskTimerAsync(final Runnable runnable, final long delay) {
        return scheduler.runTaskTimerAsynchronously(DataHandler.INSTANCE.getMain(), runnable, 0, delay);
    }
}
